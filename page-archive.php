        ...
        <ul class="work_list">
          <li class="work_item">
            <a href="work_tenkue.html">
              <div class="work_img">
                <img src="<?php echo get_template_directory_uri(); ?>/common/img/tenkue/tenkue_top.jpg">
              </div>
          ...
          <li class="work_item">
            <a href="<?php echo get_permalink(45); ?>">
              <div class="work_img">
                <img src="<?php echo get_template_directory_uri(); ?>/common/img/portfolio/portfolio_top.png">
              </div>
          ...
          <li class="work_item">
            <a href="<?php echo get_permalink(39); ?>">
              <div class="work_img">
                <img src="<?php echo get_template_directory_uri(); ?>/common/img/yahata/yahata_top.jpg">
              </div>
              <p class="work_txt">Web Desgin</p>
          ...
          <li class="work_item">
            <a href="<?php echo get_permalink(35); ?>">
              <div class="work_img">
                <img src="<?php echo get_template_directory_uri(); ?>/common/img/nabeshima/nabeshima_top.png">
              </div>
              <p class="work_txt">Web Desgin</p>
          ...
          <li class="work_item">
            <a href="//github.com/MASAKi-cell/myblog/blob/main/README.md">
              <div class="work_img">
                <img src="<?php echo get_template_directory_uri(); ?>/common/img/wp_top.jpeg">
              </div>
          ...
          <li class="work_item">
            <a href="//www.multispots.net/">
              <div class="work_img">
                <img src="<?php echo get_template_directory_uri(); ?>/common/img/Manabito_top.png">
              </div>
              <p class="work_txt">Blog</p>
          ...
          <li class="work_item">
            <a href="//twitter.com/bje351493">
              <div class="work_img">
                <img src="<?php echo get_template_directory_uri(); ?>/common/img/Minesweeper/Minesweeper.png">
              </div>
              <p class="work_txt">App</p>
          ...
          <li class="work_item">
            <a href="<?php echo get_permalink(43); ?>">
              <div class="work_img">
                <img src="<?php echo get_template_directory_uri(); ?>/common/img/seika/seika__top.png">
              </div>
              <p class="work_txt">Web Desgin</p>
          ...
          <li class="work_item">
            <a href="//twitter.com/bje351493">
              <div class="work_img">
                <img src="//i.gyazo.com/c47874a709409108eb76c5d38adcdfa6.png">
              </div>
          ...
          <li class="work_item">
            <a href="<?php echo get_permalink(47); ?>">
              <div class="work_img">
                <img src="<?php echo get_template_directory_uri(); ?>/common/img/chalk/chalk__01.jpg">
              </div>
